...
path_x = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/nih_128/X_train_5.npy"
path_y = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/nih_128/y_train_5.npy"
...
print("Time to load train arrays")
path_x = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/nih_128/X_val_5.npy"
path_y = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/nih_128/y_val_5.npy"
Xval = np.load(path_x)
yval = np.load(path_y)
...
path = "/home/maharathy1/MTP/implementation/protonet_attention_signature_loss/models/nih/half_sign_loss/split5/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path + 'nih_pwas_split5_128*128_' + str(i)
...
for k in range(len(model_dict)):
    ...
    for i in range(10):
        ...
        test_episode = 1000
        lock = 1
        temp_str = path + 'nih_pwas_split5_128*128_' + str(i) + '_'+model_dict[k]
