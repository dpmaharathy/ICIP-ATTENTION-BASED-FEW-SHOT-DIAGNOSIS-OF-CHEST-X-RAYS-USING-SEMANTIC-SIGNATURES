...
path = "/home/maharathy1/MTP/implementation/MIA/models/imp/nih_128/split1/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path+ 'imp_nih_split1_128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path + 'imp_nih_split1_128_' + str(j)
...
df.to_csv('/home/maharathy1/MTP/implementation/MIA/models/imp/nih_128/csvs/output_nih_imp_split1_128_final.csv')
