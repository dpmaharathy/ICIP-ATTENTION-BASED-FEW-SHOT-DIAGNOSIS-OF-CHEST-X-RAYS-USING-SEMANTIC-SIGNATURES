# -*- coding: utf-8 -*-
"""nih-imp-final-today.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15tP1MIkWUZAnt3WxAqzNmEZocAHjba3p
"""
...
class Imp(nn.Module):
  ...
  def set_forward_loss(self, sample):
    ...
    h_train_images = torch.tensor(x_support.contiguous().view(n_way * n_support, *x_support.size()[2:]))
    h_test_images = torch.tensor(x_query.contiguous().view(n_way * n_query, *x_query.size()[2:]))
    ...
    loss = imp_loss(logits, support_targets, support_labels)
...
path = "/home/maharathy1/MTP/implementation/MIA/models/imp/chexpert_128/split1/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path+ 'imp_chexpert_split1_128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path + 'imp_chexpert_split1_128_' + str(j)
...
df.to_csv('/home/maharathy1/MTP/implementation/MIA/models/imp/chexpert_128/csvs/output_chexpert_imp_split1_128_final.csv')
