...
path_x = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/X_train_2.npy"
path_y = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/y_train_2.npy"
...
path_x = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/X_val_2.npy"
path_y = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/y_val_2.npy"
...
path_x = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/X_test_2.npy"
path_y = "/home/gayatri1/MTP/implementation/MIA/npy_dataset_128/nih_128/y_test_2.npy"
...
class Imp(nn.Module):
  ...
  def set_forward_loss(self, sample):
    ...
    #new loss
    temp = []
    df = pd.read_csv("/home/gayatri1/MTP/implementation/MIA/embeddings/nih/Sign_7-dmis-lab-biobert-v1_1_mean.csv")
...
path = "//home/gayatri1/MTP/implementation/MIA/models/proposed/nih_128/split2/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path+'proposed_nih_split2_128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path+'proposed_nih_split2_128_' + str(j)
...
df.to_csv('/home/gayatri1/MTP/implementation/MIA/models/proposed/nih_128/csvs/output_nih_proposed_split2_128_final.csv')
