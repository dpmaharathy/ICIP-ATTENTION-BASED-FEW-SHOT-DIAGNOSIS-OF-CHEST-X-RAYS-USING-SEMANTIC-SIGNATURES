...
path_x = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/X_train_2.npy"
path_y = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/y_train_2.npy"
...
print("Time to load train arrays")
path_x = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/X_val_2.npy"
path_y = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/y_val_2.npy"
...
print("Time to load train arrays")
path_x = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/X_test_2.npy"
path_y = "/home/maharathy1/MTP/implementation/MIA/npy_dataset_128/chexpert_128/y_test_2.npy"
...
sample_example = extract_sample(3, 4, 1, X_train, y_train)
...
path = '/home/maharathy1/MTP/implementation/protonet_attention_signature_loss/models/split2/'

for i in range(10):
    print("Model: ", i + 1)
    model = load_protonet_conv_cbam(
        x_dim=(3,128,128),
        hid_dim=128,
        z_dim=768,
        )
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path + 'pwas_chexpert_split2_cbam_128*128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path + 'pwas_chexpert_split2_cbam_128*128_' + str(j)
...
df.to_csv(path+'cbam_chexpert_128.csv')