...
def display_sample(sample):
    ...
    plt.axis('off')
    plt.savefig("/home/maharathy1/MTP/implementation/protonet_attention_signature_loss/images/chexpert_1.pdf")
...
test_episode = 1
lock = 1
temp_str = path +'chexpert_pwas_split2_128*128_3_Protonet_ECA'
