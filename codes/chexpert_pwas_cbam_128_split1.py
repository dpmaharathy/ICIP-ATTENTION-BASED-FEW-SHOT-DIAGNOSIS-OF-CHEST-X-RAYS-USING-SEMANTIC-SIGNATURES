...
path = '/home/maharathy1/MTP/implementation/protonet_attention_signature_loss/models/split1/'
...
#     max_epoch = 2
#     epoch_size = 500
#     temp_str = path + 'pwas_chexpert_split1_cbam_128*128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path + 'pwas_chexpert_split1_cbam_128*128_' + str(j)
