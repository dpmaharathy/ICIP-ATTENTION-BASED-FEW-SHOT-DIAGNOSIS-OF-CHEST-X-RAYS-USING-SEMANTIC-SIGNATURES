...
path = "/home/maharathy1/MTP/implementation/protonet_attention_signature_loss/models/split2/half_proto_loss/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path + 'chexpert_pwas_split2_128*128_' + str(i)
...
for k in range(len(model_dict)):
    ...
    for i in range(10):
        ...
        test_episode = 1000
        lock = 1
        temp_str = path + 'chexpert_pwas_split2_128*128_' + str(i) + '_'+model_dict[k]
