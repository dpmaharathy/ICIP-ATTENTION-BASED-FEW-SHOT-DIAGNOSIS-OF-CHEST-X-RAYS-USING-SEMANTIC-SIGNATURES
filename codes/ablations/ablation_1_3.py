...
path = "//home/maharathy1/MTP/implementation/MIA/models/ablation_1/chexpert_128/split3/"
...
for i in range(10):
    ...
    max_epoch = 2
    epoch_size = 500
    temp_str = path+'ablation_1_chexpert_split3_128_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path+'ablation_1_chexpert_split3_128_' + str(j)
...
df.to_csv('/home/maharathy1/MTP/implementation/MIA/models/ablation_1/chexpert_128/csvs/output_chexpert_ablation_1_split3_128_final.csv')
