...
path='/home/maharathy1/MTP/implementation/relationnet/models/split2/'
...
#     max_epoch = 20
#     epoch_size = 500
#     temp_str = path+'nih_relationnet_split2_' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path+'nih_relationnet_split2_' + str(j)
...
df.to_csv(path+'output_relationnet_split2.csv')
