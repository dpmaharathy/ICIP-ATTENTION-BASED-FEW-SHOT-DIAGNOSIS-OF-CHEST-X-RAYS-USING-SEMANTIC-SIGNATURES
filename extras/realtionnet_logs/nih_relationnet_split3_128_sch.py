...
path='/home/maharathy1/MTP/implementation/relationnet/models/split3/'
...
for i in range(10):
    ...
    max_epoch = 20
    epoch_size = 500
    temp_str = path+'nih_relationnet_split3_sch' + str(i)
...
for j in range(10):
    ...
    test_episode = 1000
    lock = 1
    temp_str = path+'nih_relationnet_split3_sch' + str(j)
...
df.to_csv(path+'output_relationnet_split3_sch.csv')
